...
| **Architecture & AI** | Deterministic local decision engine paired with Gemini AI acting solely as a translation/explanation layer with robust local fallback mechanisms for 100% uptime. | \`server/engines/decisionEngine.js\`, \`server/services/gemini.js\` |
